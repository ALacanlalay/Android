 ...
 */
                                            ...
                                            Log.i("distanceInMile", distanceInMiles.toString());

                                            Double distanceOneDp = (double) Math.round(distanceInMiles * 10) / 10;

                                            Log.i("distanceOneDp", distanceOneDp.toString());
                                            ...
                                            Log.i("Info", requestLocationLatLng.toString());
        ...
        if(requestActive) {
            ...
            if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                ...
                if (lastKnownLocation != null) {
                    ...
                    Toast.makeText(getApplicationContext(), "Could not find location, Please try again later", Toast.LENGTH_SHORT).show();
